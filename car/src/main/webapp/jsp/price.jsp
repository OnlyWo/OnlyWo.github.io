...
<div>
    <form action="/PriceServlet" method="get">
        <input type="text" name="min" value="" placeholder="&nbsp;请输入最低价格" style="margin-left:100px;margin-top: 20px;width:100px;height:  30px;border-radius: 20px;background-color: #b2c6ce;"/>
        <input type="text" name="max" value="" placeholder="&nbsp;请输入最高价格" style="width: 100px;height: 30px;border-radius: 20px;background-color: #b2c6ce;"/>
